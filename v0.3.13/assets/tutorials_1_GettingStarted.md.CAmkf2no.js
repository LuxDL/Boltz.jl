...
<span class="line"><span>    ),</span></span>
<span class="line"><span>)         # Total: 203_530 parameters,</span></span>
<span class="line"><span>          #        plus 0 states.</span></span></code></pre></div><p>The <code>MLP</code> function is just a convenience wrapper around <code>Lux.Chain</code> that constructs a multi-layer perceptron with the given number of layers and activation function.</p><h2 id="How-about-VGG?" tabindex="-1">How about VGG? <a class="header-anchor" href="#How-about-VGG?" aria-label="Permalink to &quot;How about VGG? {#How-about-VGG?}&quot;">​</a></h2><div class="warning custom-block"><p class="custom-block-title">Returned Values</p><p>The returned value from <code>Vision</code> module functions are a 3 tuple of (model, ps, st). The <code>ps</code> and <code>st</code> are the parameters and states of the model respectively.</p></div><p>Let&#39;s take a look at the <code>Vision</code> module. We can construct a VGG model with the following code:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model, _, _ </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Vision</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">VGG</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">13</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Chain(</span></span>
<span class="line"><span>    layer_1 = Conv((3, 3), 3 =&gt; 64, relu, pad=1),  # 1_792 parameters</span></span>
<span class="line"><span>    layer_2 = Conv((3, 3), 64 =&gt; 64, relu, pad=1),  # 36_928 parameters</span></span>
<span class="line"><span>    layer_3 = MaxPool((2, 2)),</span></span>
<span class="line"><span>    layer_4 = Conv((3, 3), 64 =&gt; 128, relu, pad=1),  # 73_856 parameters</span></span>
<span class="line"><span>    layer_5 = Conv((3, 3), 128 =&gt; 128, relu, pad=1),  # 147_584 parameters</span></span>
<span class="line"><span>    layer_6 = MaxPool((2, 2)),</span></span>
<span class="line"><span>    layer_7 = Conv((3, 3), 128 =&gt; 256, relu, pad=1),  # 295_168 parameters</span></span>
<span class="line"><span>    layer_8 = Conv((3, 3), 256 =&gt; 256, relu, pad=1),  # 590_080 parameters</span></span>
<span class="line"><span>    layer_9 = MaxPool((2, 2)),</span></span>
<span class="line"><span>    layer_10 = Conv((3, 3), 256 =&gt; 512, relu, pad=1),  # 1_180_160 parameters</span></span>
<span class="line"><span>    layer_11 = Conv((3, 3), 512 =&gt; 512, relu, pad=1),  # 2_359_808 parameters</span></span>
<span class="line"><span>    layer_12 = MaxPool((2, 2)),</span></span>
<span class="line"><span>    layer_13 = Conv((3, 3), 512 =&gt; 512, relu, pad=1),  # 2_359_808 parameters</span></span>
<span class="line"><span>    layer_14 = Conv((3, 3), 512 =&gt; 512, relu, pad=1),  # 2_359_808 parameters</span></span>
<span class="line"><span>    layer_15 = MaxPool((2, 2)),</span></span>
<span class="line"><span>    layer_16 = Lux.FlattenLayer{Nothing}(nothing),</span></span>
<span class="line"><span>    layer_17 = Dense(25088 =&gt; 4096, relu),  # 102_764_544 parameters</span></span>
<span class="line"><span>    layer_18 = Dropout(0.5),</span></span>
<span class="line"><span>    layer_19 = Dense(4096 =&gt; 4096, relu),  # 16_781_312 parameters</span></span>
<span class="line"><span>    layer_20 = Dropout(0.5),</span></span>
<span class="line"><span>    layer_21 = Dense(4096 =&gt; 1000),     # 4_097_000 parameters</span></span>
<span class="line"><span>)         # Total: 133_047_848 parameters,</span></span>
<span class="line"><span>          #        plus 4 states.</span></span></code></pre></div><p>We can also load pretrained ImageNet weights using</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model, _, _ </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Vision</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">VGG</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">13</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; pretrained</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Chain(</span></span>
<span class="line"><span>    layer_1 = Conv((3, 3), 3 =&gt; 64, relu, pad=1),  # 1_792 parameters</span></span>
<span class="line"><span>    layer_2 = Conv((3, 3), 64 =&gt; 64, relu, pad=1),  # 36_928 parameters</span></span>
<span class="line"><span>    layer_3 = MaxPool((2, 2)),</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model, _, _ </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Vision</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">ResNet</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">18</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Chain(</span></span>
...
<span class="line"><span>                    layer_3 = WrappedFunction{:direct_call}(NNlib.relu),</span></span>
...
<span class="line"><span>        layer_2 = WrappedFunction{:direct_call}(MLUtils.flatten),</span></span>
...
<span class="line"><span>  JULIA_DEBUG = Literate</span></span></code></pre></div><hr><p><em>This page was generated using <a href="https://github.com/fredrikekre/Literate.jl" target="_blank" rel="noreferrer">Literate.jl</a>.</em></p>`,29),i=[l];function t(r,c,h,d,o,k){return n(),a("div",null,i)}const y=s(e,[["render",t]]);export{_ as __pageData,y as default};
