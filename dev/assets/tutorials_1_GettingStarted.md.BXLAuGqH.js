...
<span class="line"><span>   6039.4 ms  ✓ LuxLib</span></span>
<span class="line"><span>   9082.8 ms  ✓ Lux</span></span>
<span class="line"><span>   2891.7 ms  ✓ Lux → LuxMLUtilsExt</span></span>
<span class="line"><span>   3274.4 ms  ✓ Lux → LuxZygoteExt</span></span>
<span class="line"><span>  4 dependencies successfully precompiled in 19 seconds. 207 already precompiled.</span></span>
<span class="line"><span>Precompiling Boltz...</span></span>
<span class="line"><span>   3483.5 ms  ✓ Lux → LuxFluxExt</span></span>
<span class="line"><span>   5242.5 ms  ✓ Boltz</span></span>
<span class="line"><span>   2741.8 ms  ✓ Boltz → BoltzZygoteExt</span></span>
<span class="line"><span>  3 dependencies successfully precompiled in 12 seconds. 213 already precompiled.</span></span></code></pre></div><h2 id="Multi-Layer-Perceptron" tabindex="-1">Multi-Layer Perceptron <a class="header-anchor" href="#Multi-Layer-Perceptron" aria-label="Permalink to &quot;Multi-Layer Perceptron {#Multi-Layer-Perceptron}&quot;">​</a></h2><p>If we were to do this in <code>Lux.jl</code> we would write the following:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Chain</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
