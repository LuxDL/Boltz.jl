import{_ as a,c as n,a2 as p,o as l}from"./chunks/framework.Crj1WG-K.js";const k=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/1_GettingStarted.md","filePath":"tutorials/1_GettingStarted.md","lastUpdated":null}'),e={name:"tutorials/1_GettingStarted.md"};function i(t,s,r,c,o,h){return l(),n("div",null,s[0]||(s[0]=[p(`<h1 id="Getting-Started" tabindex="-1">Getting Started <a class="header-anchor" href="#Getting-Started" aria-label="Permalink to &quot;Getting Started {#Getting-Started}&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">Prerequisites</p><p>Here we assume that you are familiar with <a href="https://lux.csail.mit.edu/stable/" target="_blank" rel="noreferrer"><code>Lux.jl</code></a>. If not please take a look at the <a href="https://lux.csail.mit.edu/stable/tutorials/" target="_blank" rel="noreferrer">Lux.jl tutoials</a>.</p></div><p><code>Boltz.jl</code> is just like <code>Lux.jl</code> but comes with more &quot;batteries included&quot;. Let&#39;s start by defining an MLP model.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Lux, Boltz, Random</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Precompiling Lux...</span></span>
<span class="line"><span>    887.6 ms  ✓ InverseFunctions</span></span>
<span class="line"><span>    895.4 ms  ✓ PrettyPrint</span></span>
<span class="line"><span>   1115.7 ms  ✓ StatsAPI</span></span>
<span class="line"><span>   1045.0 ms  ✓ ShowCases</span></span>
<span class="line"><span>   1572.9 ms  ✓ InitialValues</span></span>
<span class="line"><span>    724.4 ms  ✓ DefineSingletons</span></span>
<span class="line"><span>    878.0 ms  ✓ CompositionsBase</span></span>
<span class="line"><span>    973.0 ms  ✓ DelimitedFiles</span></span>
<span class="line"><span>    957.7 ms  ✓ Missings</span></span>
<span class="line"><span>    868.8 ms  ✓ ContextVariablesX</span></span>
<span class="line"><span>   2053.6 ms  ✓ Baselet</span></span>
<span class="line"><span>   1159.3 ms  ✓ SortingAlgorithms</span></span>
<span class="line"><span>   2264.1 ms  ✓ SimpleTraits</span></span>
<span class="line"><span>   1819.1 ms  ✓ Optimisers</span></span>
<span class="line"><span>   1142.4 ms  ✓ InverseFunctions → InverseFunctionsTestExt</span></span>
<span class="line"><span>   1007.7 ms  ✓ InverseFunctions → InverseFunctionsDatesExt</span></span>
<span class="line"><span>    937.6 ms  ✓ LogExpFunctions → LogExpFunctionsInverseFunctionsExt</span></span>
<span class="line"><span>    904.0 ms  ✓ NameResolution</span></span>
<span class="line"><span>   2376.6 ms  ✓ SplittablesBase</span></span>
<span class="line"><span>    973.1 ms  ✓ CompositionsBase → CompositionsBaseInverseFunctionsExt</span></span>
<span class="line"><span>   1173.2 ms  ✓ FLoopsBase</span></span>
<span class="line"><span>   2808.0 ms  ✓ OneHotArrays</span></span>
<span class="line"><span>   3635.7 ms  ✓ StatsBase</span></span>
<span class="line"><span>   4156.9 ms  ✓ Accessors</span></span>
<span class="line"><span>    994.5 ms  ✓ Accessors → AccessorsStructArraysExt</span></span>
<span class="line"><span>   1353.4 ms  ✓ Accessors → AccessorsTestExt</span></span>
<span class="line"><span>   2803.3 ms  ✓ MLDataDevices → MLDataDevicesOneHotArraysExt</span></span>
<span class="line"><span>   1540.4 ms  ✓ Accessors → AccessorsDatesExt</span></span>
<span class="line"><span>    978.1 ms  ✓ Accessors → AccessorsStaticArraysExt</span></span>
<span class="line"><span>    823.7 ms  ✓ BangBang</span></span>
<span class="line"><span>    951.7 ms  ✓ BangBang → BangBangStructArraysExt</span></span>
<span class="line"><span>    964.7 ms  ✓ BangBang → BangBangChainRulesCoreExt</span></span>
<span class="line"><span>   1087.2 ms  ✓ BangBang → BangBangTablesExt</span></span>
<span class="line"><span>   1139.2 ms  ✓ BangBang → BangBangStaticArraysExt</span></span>
<span class="line"><span>    910.4 ms  ✓ MicroCollections</span></span>
<span class="line"><span>   3299.9 ms  ✓ Transducers</span></span>
<span class="line"><span>   1046.7 ms  ✓ Transducers → TransducersAdaptExt</span></span>
<span class="line"><span>  22131.4 ms  ✓ MLStyle</span></span>
<span class="line"><span>   4061.6 ms  ✓ JuliaVariables</span></span>
<span class="line"><span>   4752.1 ms  ✓ FLoops</span></span>
<span class="line"><span>   6499.5 ms  ✓ MLUtils</span></span>
<span class="line"><span>   2296.1 ms  ✓ MLDataDevices → MLDataDevicesMLUtilsExt</span></span>
<span class="line"><span>   9159.1 ms  ✓ Lux</span></span>
<span class="line"><span>   2901.7 ms  ✓ Lux → LuxMLUtilsExt</span></span>
<span class="line"><span>   3237.9 ms  ✓ Lux → LuxZygoteExt</span></span>
...
<span class="line"><span>    518.8 ms  ✓ ProgressLogging</span></span>
<span class="line"><span>   6454.2 ms  ✓ Flux</span></span>
<span class="line"><span>   3506.6 ms  ✓ Lux → LuxFluxExt</span></span>
<span class="line"><span>   5094.1 ms  ✓ Boltz</span></span>
<span class="line"><span>   2700.0 ms  ✓ Boltz → BoltzZygoteExt</span></span>
<span class="line"><span>  5 dependencies successfully precompiled in 18 seconds. 209 already precompiled.</span></span></code></pre></div><h2 id="Multi-Layer-Perceptron" tabindex="-1">Multi-Layer Perceptron <a class="header-anchor" href="#Multi-Layer-Perceptron" aria-label="Permalink to &quot;Multi-Layer Perceptron {#Multi-Layer-Perceptron}&quot;">​</a></h2><p>If we were to do this in <code>Lux.jl</code> we would write the following:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">model </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Chain</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
