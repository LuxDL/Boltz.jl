import{_ as a,o as n,c as p,a2 as e}from"./chunks/framework.Bjxu7YHf.js";const k=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/1_GettingStarted.md","filePath":"tutorials/1_GettingStarted.md","lastUpdated":null}'),l={name:"tutorials/1_GettingStarted.md"};function i(t,s,r,c,o,h){return n(),p("div",null,s[0]||(s[0]=[e(`<h1 id="Getting-Started" tabindex="-1">Getting Started <a class="header-anchor" href="#Getting-Started" aria-label="Permalink to &quot;Getting Started {#Getting-Started}&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">Prerequisites</p><p>Here we assume that you are familiar with <a href="https://lux.csail.mit.edu/stable/" target="_blank" rel="noreferrer"><code>Lux.jl</code></a>. If not please take a look at the <a href="https://lux.csail.mit.edu/stable/tutorials/" target="_blank" rel="noreferrer">Lux.jl tutoials</a>.</p></div><p><code>Boltz.jl</code> is just like <code>Lux.jl</code> but comes with more &quot;batteries included&quot;. Let&#39;s start by defining an MLP model.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Lux, Boltz, Random</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Precompiling Lux...</span></span>
<span class="line"><span>   1028.8 ms  ✓ Functors</span></span>
<span class="line"><span>   1301.2 ms  ✓ LuxCore</span></span>
<span class="line"><span>    981.5 ms  ✓ LuxCore → LuxCoreFunctorsExt</span></span>
<span class="line"><span>    995.0 ms  ✓ LuxCore → LuxCoreEnzymeCoreExt</span></span>
<span class="line"><span>   1427.0 ms  ✓ MLDataDevices</span></span>
<span class="line"><span>   1249.6 ms  ✓ LuxCore → LuxCoreChainRulesCoreExt</span></span>
<span class="line"><span>   2051.2 ms  ✓ Optimisers</span></span>
<span class="line"><span>    990.2 ms  ✓ LuxCore → LuxCoreSetfieldExt</span></span>
<span class="line"><span>   1111.9 ms  ✓ MLDataDevices → MLDataDevicesChainRulesCoreExt</span></span>
<span class="line"><span>    825.3 ms  ✓ MLDataDevices → MLDataDevicesFillArraysExt</span></span>
<span class="line"><span>   1404.4 ms  ✓ MLDataDevices → MLDataDevicesSparseArraysExt</span></span>
<span class="line"><span>   2580.0 ms  ✓ MLDataDevices → MLDataDevicesGPUArraysExt</span></span>
<span class="line"><span>   2970.3 ms  ✓ MLDataDevices → MLDataDevicesOneHotArraysExt</span></span>
<span class="line"><span>    858.4 ms  ✓ LuxCore → LuxCoreMLDataDevicesExt</span></span>
<span class="line"><span>   2798.4 ms  ✓ MLDataDevices → MLDataDevicesZygoteExt</span></span>
<span class="line"><span>   1354.1 ms  ✓ MLDataDevices → MLDataDevicesChainRulesExt</span></span>
<span class="line"><span>   3416.9 ms  ✓ MLDataDevices → MLDataDevicesMLUtilsExt</span></span>
<span class="line"><span>   6011.7 ms  ✓ LuxLib</span></span>
<span class="line"><span>   9330.1 ms  ✓ Lux</span></span>
<span class="line"><span>   2907.2 ms  ✓ Lux → LuxMLUtilsExt</span></span>
<span class="line"><span>   3307.1 ms  ✓ Lux → LuxZygoteExt</span></span>
...
<span class="line"><span>   6467.1 ms  ✓ Flux</span></span>
<span class="line"><span>   3575.4 ms  ✓ Lux → LuxFluxExt</span></span>
<span class="line"><span>   5199.0 ms  ✓ Boltz</span></span>
<span class="line"><span>   2692.6 ms  ✓ Boltz → BoltzZygoteExt</span></span>
