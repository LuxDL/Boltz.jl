import{_ as a,o as n,c as p,a2 as e}from"./chunks/framework.BsIQ6Aep.js";const k=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/1_GettingStarted.md","filePath":"tutorials/1_GettingStarted.md","lastUpdated":null}'),l={name:"tutorials/1_GettingStarted.md"};function i(t,s,r,c,o,h){return n(),p("div",null,s[0]||(s[0]=[e(`<h1 id="Getting-Started" tabindex="-1">Getting Started <a class="header-anchor" href="#Getting-Started" aria-label="Permalink to &quot;Getting Started {#Getting-Started}&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">Prerequisites</p><p>Here we assume that you are familiar with <a href="https://lux.csail.mit.edu/stable/" target="_blank" rel="noreferrer"><code>Lux.jl</code></a>. If not please take a look at the <a href="https://lux.csail.mit.edu/stable/tutorials/" target="_blank" rel="noreferrer">Lux.jl tutoials</a>.</p></div><p><code>Boltz.jl</code> is just like <code>Lux.jl</code> but comes with more &quot;batteries included&quot;. Let&#39;s start by defining an MLP model.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Lux, Boltz, Random</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Precompiling Lux...</span></span>
<span class="line"><span>    996.2 ms  ✓ Functors</span></span>
<span class="line"><span>   1255.6 ms  ✓ LuxCore</span></span>
<span class="line"><span>   1415.7 ms  ✓ MLDataDevices</span></span>
<span class="line"><span>   1039.7 ms  ✓ LuxCore → LuxCoreFunctorsExt</span></span>
<span class="line"><span>   1069.9 ms  ✓ LuxCore → LuxCoreEnzymeCoreExt</span></span>
<span class="line"><span>   1133.8 ms  ✓ LuxCore → LuxCoreChainRulesCoreExt</span></span>
<span class="line"><span>   1860.0 ms  ✓ Optimisers</span></span>
<span class="line"><span>   1034.8 ms  ✓ LuxCore → LuxCoreSetfieldExt</span></span>
<span class="line"><span>   1096.7 ms  ✓ MLDataDevices → MLDataDevicesChainRulesCoreExt</span></span>
<span class="line"><span>    975.9 ms  ✓ MLDataDevices → MLDataDevicesFillArraysExt</span></span>
<span class="line"><span>   2222.8 ms  ✓ MLDataDevices → MLDataDevicesGPUArraysExt</span></span>
<span class="line"><span>   1443.4 ms  ✓ MLDataDevices → MLDataDevicesSparseArraysExt</span></span>
<span class="line"><span>   3348.9 ms  ✓ MLDataDevices → MLDataDevicesOneHotArraysExt</span></span>
<span class="line"><span>    983.0 ms  ✓ LuxCore → LuxCoreMLDataDevicesExt</span></span>
<span class="line"><span>   1402.5 ms  ✓ MLDataDevices → MLDataDevicesChainRulesExt</span></span>
<span class="line"><span>   2694.0 ms  ✓ MLDataDevices → MLDataDevicesZygoteExt</span></span>
<span class="line"><span>   3355.4 ms  ✓ MLDataDevices → MLDataDevicesMLUtilsExt</span></span>
<span class="line"><span>   5882.9 ms  ✓ LuxLib</span></span>
<span class="line"><span>   9079.3 ms  ✓ Lux</span></span>
<span class="line"><span>   2818.5 ms  ✓ Lux → LuxMLUtilsExt</span></span>
<span class="line"><span>   3232.8 ms  ✓ Lux → LuxZygoteExt</span></span>
<span class="line"><span>  21 dependencies successfully precompiled in 26 seconds. 190 already precompiled.</span></span>
<span class="line"><span>Precompiling Boltz...</span></span>
<span class="line"><span>   6425.5 ms  ✓ Flux</span></span>
<span class="line"><span>   3514.6 ms  ✓ Lux → LuxFluxExt</span></span>
<span class="line"><span>   5240.1 ms  ✓ Boltz</span></span>
<span class="line"><span>   2734.8 ms  ✓ Boltz → BoltzZygoteExt</span></span>
